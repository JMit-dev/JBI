...
public class EditAndControlQueueController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        loadInto(runningPlanContainer, "/view/ReRunningPlan.fxml", new ReRunningPlanController(false));
        loadInto(planQueueContainer, "/view/RePlanQueue.fxml", new RePlanQueueController(false));
        loadInto(planHistoryContainer, "/view/RePlanHistory.fxml", new RePlanHistoryController(false));
    }
